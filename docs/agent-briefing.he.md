...
> **עדכון 22.9:** גרסת השבועיים הסתיימה בתג v1.0.0, והוא נשאר גרסת הגיבוי. באותו יום חזרה התוכנית המלאה: כל מה שנחתך נבנה בימים 10 עד 16, והחזרות, הסרטון והחלפת הסודות עוברים לימים 17 עד 19, עד 4.10. התאריכים נמצאים בסעיף "Four-week plan restored" של תוכנית העבודה וברשימת ההתקדמות.
