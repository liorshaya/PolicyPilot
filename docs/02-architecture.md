...
| `policypilot.rag.min-score` | 0.35 | 0.58 |
| `policypilot.ai.prompt-versions.*` | `author=v2, review=v1, explain=v1, answer=v3, change=v2` | same |
