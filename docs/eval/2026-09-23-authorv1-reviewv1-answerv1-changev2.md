...
Document 4, "Evaluation Set and Metrics". Prompt versions: `author` v1, `review` v1, `answer` v1, `change` v2. Targets are the strong model's; the Ollama column is reported without targets, to show the local path works and to quantify the gap.
...
| Change correctness | 0.83 | 1.00 (6 of 6) | not run | PASS |
