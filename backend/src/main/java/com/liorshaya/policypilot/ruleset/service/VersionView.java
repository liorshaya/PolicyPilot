 ...
 * sandbox's copy of a protected rule set names the origin in {@code forkedFromId}. A draft carries its review once it
 * has one (Document 2, Flow 1); a published version keeps the review it was published with.
 */
