...
public final class PromptRegistry {
    ...
    /** The prompts that exist so far; review, explain and change join them on their own days. */
    public static final List<String> PROMPTS = List.of("author", "repair", "answer");
